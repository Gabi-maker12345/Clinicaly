...
<?php $component->withAttributes([]); ?>
    ...
    <main class="mt-12 max-w-5xl mx-auto px-6 pb-20" x-data="{ filter: 'all' }" style="background: var(--bg); color: var(--tx);".
        ...
        <section class="mb-8">
            <div class="bg-amber-50 border border-amber-100 rounded-[30px] p-6 flex items-center gap-4">
                ...
                <p class="text-amber-900 font-medium text-sm">
                    <strong><?php echo e($counts['all']); ?> diagnósticos</strong> aguardam revisão — ordenados por gravidade e data.
                </p>
            </div>
        </section>
                ...
                <ul class="flex flex-wrap gap-3">
                    ...
                    <li>
                        <button @click="filter = 'critico'" 
                                ...
                                class="px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all">
                            Críticos (<?php echo e($counts['critico']); ?>)
                        </button>
                    </li>
                    <li>
                    ...
                    <li>
                        <button @click="filter = 'medio_baixo'" 
                                ...
                                class="px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all">
                            Médios/Baixos (<?php echo e($counts['medio_baixo']); ?>)
                        </button>
                    </li>
                </ul>
            </nav>
        ...
        <section class="bg-white rounded-[35px] p-8 border border-slate-100 shadow-sm">
            ...
            <div class="space-y-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $diagnosticos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $diagnostico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <article x-show="filter === 'all' || filter === '<?php echo e($diagnostico->nivel_gravidade); ?>'" 
                             x-transition
                             class="p-5 border rounded-[25px] flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-[#6d55b1] transition-all <?php echo e($rowStyle); ?>">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="text-base font-bold text-slate-800"><?php echo e($diagnostico->paciente->name); ?></p>
                                <ul class="flex flex-wrap items-center gap-2 mt-2">
                                    <li>
                                        <span class="px-2.5 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest <?php echo e($badgeStyle); ?> flex items-center gap-1">
                                    ...
                                    <li>
                                        <span class="px-2.5 py-1 bg-white border border-slate-200 rounded-lg text-[9px] font-bold text-slate-600">
                                            <?php echo e($doencasStr); ?>

                                        </span>
                                    </li>
                                    <li>
                                        <span class="text-[10px] font-medium text-slate-400 flex items-center gap-1">
                                            <i class="fa-regular fa-clock"></i> <?php echo e($diagnostico->created_at->diffForHumans()); ?>
                        ...
                        <div class="flex items-center gap-3 shrink-0">
                            <form action="<?php echo e(route('messages.start', $diagnostico->id_paciente ?? $diagnostico->paciente->id)); ?>" method="POST" style="display: inline-block;">
                                <?php echo csrf_field(); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isCritico): ?>
                                <a href="<?php echo e(route('diagnostico.validar', $diagnostico->id)); ?>" class="px-5 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest bg-red-500 text-white shadow-md shadow-red-200 hover:bg-red-600 hover:scale-105 transition-all">
                                    Abrir Urgente
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('diagnostico.validar', $diagnostico->id)); ?>" class="px-5 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest bg-[#6d55b1] text-white shadow-md shadow-purple-200 hover:bg-[#5b4694] hover:scale-105 transition-all">
                                    Abrir
                                </a>
...
<?php endif; ?><?php /**PATH C:\Users\gcris\OneDrive\Documentos\Escola\Projetos Pessoais\Clinicaly\resources\views/pages/diagnostico_fila.blade.php ENDPATH**/ ?>