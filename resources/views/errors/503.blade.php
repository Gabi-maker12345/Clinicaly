...
<head>
    ...
    <title>Clinicaly — Serviço Indisponível</title>
...
<body>
    <article class="card fi fi2" style="margin-top:0;" aria-live="polite" aria-labelledby="err-ti" id="err-card">
        <div class="er-c">
            ...
            <p class="er-cd" id="err-cd">503</p>
            <p class="er-ti" id="err-ti">Serviço Indisponível</p>
            <p class="er-su" id="err-su">O serviço está temporariamente indisponível para manutenção. Voltaremos brevemente. Obrigado pela paciência!</p>
            <nav style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;" aria-label="Opções de recuperação">
                <a href="javascript:location.reload()" class="btn b-pr"><i class="fa-solid fa-refresh" aria-hidden="true"></i> Tentar Novamente</a>
            </nav>
        </div>
    </article>
