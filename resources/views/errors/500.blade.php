...
<head>
    ...
    <title>Clinicaly — Erro no Servidor</title>
...
.er-cd{font-family:'Space Mono',monospace;font-size:5.5rem;font-weight:700;line-height:1;color:var(--rd);margin-bottom:12px;}
...
<body>
    <article class="card fi fi2" style="margin-top:0;" aria-live="polite" aria-labelledby="err-ti" id="err-card">
        <div class="er-c">
            <p id="err-ico" style="font-size:3.5rem;margin-bottom:8px;" role="img" aria-hidden="true">⚠️</p>
            <p class="er-cd" id="err-cd">500</p>
            <p class="er-ti" id="err-ti">Erro no Servidor</p>
            <p class="er-su" id="err-su">Ocorreu um erro inesperado. A nossa equipa de técnicos já foi notificada. Por favor, tente novamente mais tarde.</p>
            <nav style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;" aria-label="Opções de recuperação">
                <a href="javascript:location.reload()" class="btn b-gh"><i class="fa-solid fa-refresh" aria-hidden="true"></i> Tentar Novamente</a>
                <a href="{{ route('dashboard') }}" class="btn b-pr"><i class="fa-solid fa-house" aria-hidden="true"></i> Ir para o Dashboard</a>
            </nav>
        </div>
    </article>
