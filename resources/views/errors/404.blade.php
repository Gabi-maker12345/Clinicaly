...
<head>
    ...
    <title>Clinicaly — Erro 404</title>
...
.er-cd{font-family:'Space Mono',monospace;font-size:5.5rem;font-weight:700;line-height:1;color:var(--id);margin-bottom:12px;}
...
<body>
    <article class="card fi fi2" style="margin-top:0;" aria-live="polite" aria-labelledby="err-ti" id="err-card">
        <div class="er-c">
            ...
            <p class="er-cd" id="err-cd">404</p>
            <p class="er-ti" id="err-ti">Página não encontrada</p>
            <p class="er-su" id="err-su">O endereço que está a tentar aceder não existe ou foi removido da plataforma.</p>
            <nav style="display:flex;gap:10px;flex-wrap:wrap;justify-content:center;" aria-label="Opções de recuperação">
                <a href="javascript:history.back()" class="btn b-gh"><i class="fa-solid fa-arrow-left" aria-hidden="true"></i> Voltar</a>
